...
export const translations = {
  ...
  // ==========================================
  // RESOURCE BOOKING (Platzbelegung)
  // ==========================================
  fields: {
    title: { de: "Platzbelegung", en: "Resource Booking" },
    activeFields: { de: "aktive Felder", en: "active resources" },
    total: { de: "gesamt", en: "total" },
    addField: { de: "Feld hinzufügen", en: "Add Resource" },
    fieldsTab: { de: "Felder", en: "Resources" },
    ...
    fullField: { de: "Ganzes Feld", en: "Full resource" },
    ...
    deleteConfirm: { de: "Feld wirklich löschen?", en: "Really delete this resource?" },
    deleteDesc: { de: "Diese Aktion kann nicht rückgängig gemacht werden.", en: "This action cannot be undone." },
    // Form
    newField: { de: "Neues Feld", en: "New Resource" },
    editField: { de: "Feld bearbeiten", en: "Edit Resource" },
    ...
    divisible: { de: "In Zonen teilbar", en: "Divisible into zones" },
    divisibleDesc: { de: "Erlaubt es, Trainings auf einzelnen Zonen zu buchen und die Ressource mehrfach gleichzeitig zu nutzen.", en: "Allows booking individual zones and using the resource for multiple sessions simultaneously." },
    divisibleError: { de: "Nicht möglich: Dieses Feld hat noch zukünftige Zonen-Buchungen. Bitte erst diese entfernen.", en: "Not possible: This resource has future zone bookings. Please remove them first." },
    address: { de: "Adresse / Lage", en: "Address / Location" },
    addressPlaceholder: { de: "z.B. Fußballpark BVB Hohenbuschei, Platz 1", en: "e.g. Sports facility, Pitch 1" },
    active: { de: "Aktiv", en: "Active" },
    activeDesc: { de: "Inaktive Felder können nicht gebucht werden.", en: "Inactive resources cannot be booked." },
    ...
    unassignedEventsTitle: { de: "Veranstaltungen ohne Feldzuweisung", en: "Events without resource assignment" },
    noUnassignedEvents: { de: "Keine unzugewiesenen Veranstaltungen an diesem Tag.", en: "No unassigned events on this day." },
    selectFieldPlaceholder: { de: "Feld wählen...", en: "Select resource..." },
    assignField: { de: "Zuweisen", en: "Assign" },
    removeBooking: { de: "Feldzuweisung entfernen", en: "Remove resource assignment" },
    // FieldDetailModal
    ...
    indoorLabel: { de: "Halle", en: "Indoor" },
    outdoorLabel: { de: "Outdoor", en: "Outdoor" },
    // FieldPicker
    fieldPickerLabel: { de: "Feld / Anlage", en: "Resource" },
    noFieldOption: { de: "– Kein Feld –", en: "– No resource –" },
    zonesCount6Suffix: { de: "(6 Zonen)", en: "(6 zones)" },
    halleSuffix: { de: "Halle", en: "Indoor" },
    removeField: { de: "Feld entfernen", en: "Remove resource" },
    fullFieldScope: { de: "Ganzes Feld", en: "Full resource" },
    ...
    matchFullFieldInfo: { de: "Spiele buchen immer das gesamte Feld.", en: "Matches always book the full resource." },
    ...
    maintenanceFieldLabel: { de: "Feld", en: "Resource" },
    ...
    // Venue
    venue: { de: "Anlage / Venue", en: "Venue" },
    venues: { de: "Anlagen", en: "Venues" },
    selectVenue: { de: "Anlage wählen...", en: "Select venue..." },
    addVenue: { de: "+ Anlage hinzufügen", en: "+ Add Venue" },
    noVenue: { de: "Keine Anlage", en: "No venue" },
    // Zone count
    zoneCountLabel: { de: "Zonen-Aufteilung", en: "Zone Split" },
  },
  ...
  sidebar: {
    ...
    competitions: { de: "Spielbetrieb", en: "Competitions" },
    matches: { de: "Spiele", en: "Matches" },
    playerPasses: { de: "Spielerpässe", en: "Player Passes" },
    productsPayment: { de: "Produkte & Zahlung", en: "Products & Payment" },
    products: { de: "Produkte", en: "Products" },
    subscriptions: { de: "Abonnements", en: "Subscriptions" },
    invoices: { de: "Rechnungen", en: "Invoices" },
    paymentLinks: { de: "Zahlungslinks", en: "Payment Links" },
    events: { de: "Veranstaltungen", en: "Events" },
    fieldBooking: { de: "Platzbelegung", en: "Resource Booking" },
    clubManagement: { de: "Vereinsverwaltung", en: "Club Management" },
    departments: { de: "Abteilungen", en: "Departments" },
    committees: { de: "Gremien", en: "Committees" },
    volunteering: { de: "Ehrenamt", en: "Volunteering" },
    ...
    inboxPilot: { de: "Postfach (Pilot)", en: "Inbox (Pilot)" },
    chatModeration: { de: "Chat-Moderation", en: "Chat Moderation" },
    inboxMvp: { de: "Postfach (MVP)", en: "Inbox (MVP)" },
    clubNews: { de: "Club News", en: "Club News" },
    documents: { de: "Dokumente", en: "Documents" },
    settings: { de: "Einstellungen", en: "Settings" },
    // Member sections
    ...
    // Toggle & labels
    clubToggle: { de: "Verein", en: "Club" },
    meToggle: { de: "Ich", en: "Me" },
    clubAdminSubtitle: { de: "Vereinsverwaltung", en: "Club Administration" },
    memberSubtitle: { de: "Mitglied", en: "Member" },
    viewFor: { de: "Ansicht für", en: "View for" },
  },
