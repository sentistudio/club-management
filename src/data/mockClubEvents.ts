...
// ==========================================
// DEMO HELPER: dates relative to today
// Every page load the "current window" events are always
// in the current week → the demo never runs out of future events.
// ==========================================
...
export const mockClubEvents: ClubEvent[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(92) + "T23:59:00",
    maxParticipants: 30,
    rsvpStats: {
      invited: 0,
      confirmed: 0,
  ...
  // ═══════════════════════════════════════════
  {
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(2) + "T23:59:00",
    rsvpStats: {
      invited: 42,
      confirmed: 18,
      declined: 5,
  ...
  // ═══════════════════════════════════════════
  {
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(112) + "T23:59:00",
    maxParticipants: 50,
    rsvpStats: {
      invited: 89,
      confirmed: 0,
  ...
  // ═══════════════════════════════════════════
  // TODAY TRAINING EVENTS – populate Belegung tab
  // ═══════════════════════════════════════════
  {
    id: "evt_fitness_heute",
    title: "Fitness Morgengruppe",
    description: "Wöchentliches Fitness-Training.",
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: false,
    rsvpStats: { invited: 24, confirmed: 18, declined: 0, pending: 6, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
    createdByName: ADMIN_USER.name,
    updatedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
  ...
  {
    id: "evt_vb_training_heute",
    title: "Volleyball Training Damen",
    description: "Hallensaison-Training.",
    date: daysFromToday(0),
    startTime: "10:00",
    endTime: "12:00",
    location: "Sporthalle",
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: false,
    rsvpStats: { invited: 14, confirmed: 12, declined: 0, pending: 2, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
  ...
  {
    id: "evt_u16_training_heute",
    title: "Training Fußball U16",
    description: "Jugendtraining auf Hauptplatz – Zone 1–3.",
    date: daysFromToday(0),
    startTime: "14:00",
    endTime: "16:00",
    location: "Hauptplatz",
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: false,
    rsvpStats: { invited: 18, confirmed: 16, declined: 0, pending: 2, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
  ...
  {
    id: "evt_frauen_training_heute",
    title: "Training Frauen Ü40",
    description: "Training auf Hauptplatz – Zone 4–6.",
    date: daysFromToday(0),
    startTime: "15:30",
    endTime: "17:30",
    location: "Hauptplatz",
  ...
  {
    id: "evt_schiri_praxis_heute",
    title: "Schiri-Praxiseinheit",
    description: "Praktische Übungen auf dem Nebenplatz.",
    date: daysFromToday(0),
    startTime: "10:30",
    endTime: "12:30",
    location: "Nebenplatz",
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: false,
    rsvpStats: { invited: 8, confirmed: 7, declined: 0, pending: 1, waitlist: 0 },
    status: "published" as EventStatus,
    ...
    fieldId: "field_nebenplatz",
    bookingScope: "zones",
    bookedZoneIds: ["field_nebenplatz_z1", "field_nebenplatz_z2", "field_nebenplatz_z3"],
  },
  {
    id: "evt_kondition_heute",
    title: "Konditionstraining Männer Ü40",
    description: "Konditions- und Lauftraining auf der Trainingswiese.",
    date: daysFromToday(0),
    startTime: "17:00",
    endTime: "18:30",
    ...
    fieldId: "field_trainingswiese",
    bookingScope: "zones",
    bookedZoneIds: ["field_trainingswiese_z1", "field_trainingswiese_z2", "field_trainingswiese_z3"],
  },
...

  {
    ...
    visibility: "private" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(-1) + "T18:00:00",
...

  {
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(3) + "T12:00:00",
  ...
  // ═══════════════════════════════════════════
  {
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(9) + "T23:59:00",
  ...
  // ═══════════════════════════════════════════
  // PERSONA-SPECIFIC RECURRING EVENTS
  // ═══════════════════════════════════════════
  ...
  // ── Lena – Fitness Morgengruppe ──
  {
    id: "evt_fitness_lena_d0",
    title: "Fitness Morgengruppe",
    date: daysFromToday(0),
    startTime: "07:00",
    endTime: "08:00",
  ...
  // ── Flurina – Volleyball U16 ──
  {
    id: "evt_vb_u16_d0",
    title: "Training Volleyball U16",
    date: daysFromToday(0),
    startTime: "17:30",
    endTime: "19:00",
  ...
  },
  {
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: false,
    rsvpStats: { invited: 14, confirmed: 12, declined: 1, pending: 1, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
  ...
  },
  {
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(8) + "T23:59:00",
    rsvpStats: { invited: 14, confirmed: 9, declined: 0, pending: 5, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
  ...
  },
  {
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(14) + "T23:59:00",
    rsvpStats: { invited: 14, confirmed: 8, declined: 0, pending: 6, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
  ...
  // ── All members ──
  {
    ...
    title: "Jahreshauptversammlung 2026/27",
    ...
    visibility: "public" as EventVisibility,
    rsvpRequired: true,
    rsvpDeadline: daysFromToday(12) + "T23:59:00",
    maxParticipants: 150,
    rsvpStats: { invited: 394, confirmed: 45, declined: 8, pending: 341, waitlist: 0 },
    status: "published" as EventStatus,
    statusHistory: createHistory({ status: "draft", daysAgo: 7 }, { status: "published", daysAgo: 5 }),
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
    createdBy: ADMIN_USER.id,
